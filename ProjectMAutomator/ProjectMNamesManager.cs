...
namespace ProjectMAutomator {
    ...
    public partial class ProjectMNamesManager : Form {
        ...
        private async void saveProfileButton_Click(object sender, EventArgs e) {
            ...
            IMongoCollection<GamecubeControllerConfig> collection = db.GetCollection<GamecubeControllerConfig>(MongoResources.controllersCollection);
            if (usernameExists) {
